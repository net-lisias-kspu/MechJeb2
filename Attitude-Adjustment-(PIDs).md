...
The Attitude Adjustment panel controls the settings for the PID (Proportional-Integral-Derivative) controllers that MechJeb uses for controlling the attitude of vessels.
