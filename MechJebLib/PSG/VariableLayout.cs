namespace MechJebLib.PSG
{
    public readonly struct VariableLayout
    {
        ...
        public static int NumConstraintsForPhases(int n, int k, int numPhases, Problem problem) => (10 + 4 * k) * numPhases + (n - 1) * numPhases * 7 * 2 + problem.Terminal.NumConstraints;
    }
}
